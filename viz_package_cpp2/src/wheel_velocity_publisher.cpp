...
{
public:
    WheelVelocityPublisher(rclcpp::NodeOptions options=rclcpp::NodeOptions()):Node("wheel_velocity_publisher", options)
    {
       // Se suscribe a comandos para asignar la velocidad al robot (suscripción a cmd_vel)
        _vel_subscription = this->create_subscription<geometry_msgs::msg::Twist>(
            "cmd_vel", 10, std::bind(&WheelVelocityPublisher::set_velocity, this, _1));
        ...
        _timer = this->create_wall_timer(33ms, std::bind(&WheelVelocityPublisher::publish, this));
    }
...
void WheelVelocityPublisher::set_velocity(const geometry_msgs::msg::Twist vel)
{
    ...
    //  front_right_wheel
    //  rear_right_wheel
void WheelVelocityPublisher::publish()
{
